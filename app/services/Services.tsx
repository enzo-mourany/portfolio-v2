    ...
    <section id='services' className='w-screen h-fit pb-20'>
      <div className='flex flex-col justify-center items-center w-full h-full'>
        <div className='flex flex-col items-center p-20'>
          ...
          <h3 className='w-full sm:w-3/5 lg:w-3/4 text-xl sm:text-3xl lg:text-w-4xl opacity-50 text-center'>Je construis votre marque pour que vous puissiez vous concentrer sur le reste.</h3>
        </div>

    ...
    <section id='solution' className='w-screen h-screen bg-blue'>
      <div className='flex flex-col h-full'>
        <div className='flex flex-col justify-start w-full lg:w-3/5 h-full p-8 sm:p-20 gap-5'>
          <h3 className='text-w-xl lg:text-w-base text-white leading-tight'>En positionnant mes clients en tant que <strong>références</strong> dans leur secteur d&apos;activité, je les aide à sortir du lot et à se <strong>démarquer</strong> significativement sur un marché <strong>concurrentiel</strong>.</h3>

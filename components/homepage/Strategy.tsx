    ...
    <section id='strategy' className='w-screen bg-blue'>
      <div className='flex flex-col lg:flex-row w-full h-full'>
        ...
        <div className='flex flex-col w-full lg:w-1/2 h-full p-8 sm:p-20 gap-5'>
          <h4 className='text-w-xl lg:text-w-base text-white leading-tight'>Je joins mes forces à celles de votre équipe par le biais d&apos;une stratégie, d&apos;une conception et d&apos;un développement technique. Votre marque raconte une histoire unique, et je suis là pour lui donner vie.</h4>
          <Link href='/contact'>
